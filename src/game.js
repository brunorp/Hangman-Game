...
function randomWord(n){
	switch(n){
		case 0:
			word = 'Mario';
			source = '../assets/img/mri.png'
		break;
		
		case 1:
			word =  'Princess Peach';
			source = '../assets/img/peach.png'
		break;

		case 2:
			word = 'Toad';
			source = '../assets/img/toad.png'
		break;

		case 3:
			word =  'Yoshi';
			source = '../assets/img/yoshi.png'
		break;

		case 4:
			word =  'Luigi';
			source = '../assets/img/luigi.png'
		break;

		case 5:
			word =  'King Boo';
			source = '../assets/img/boo.png'
		break;

		case 6:
			word =  'Baby Luigi';
			source = '../assets/img/bluigi.png'
		break;

		case 7:
			word =  'Baby Mario';
			source = '../assets/img/bmario.png'
		break;

		case 8:
			word = 'Bowser';
			source = '../assets/img/bowser.png'
		break;

		case 9:
			word = 'Koopa Troopa';
			source = '../assets/img/kt.png'
		break;

		case 10:
			word = 'Goomba';
			source = '../assets/img/goomba.png'
		break;
	}
}
